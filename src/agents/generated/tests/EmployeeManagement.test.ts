...
/**
 * E2E Tests for EmployeeManagement
 * E2E tests for employee management workflows
...
test.describe('EmployeeManagement E2E Tests', () => {
  ...
  test('should load dashboard successfully', async ({ page }) => {
    await expect(page.locator('h1')).toContainText('EmployeeManagement');
